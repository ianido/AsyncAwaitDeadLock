...
namespace Website.DLock
{
    public static class TaskUtils
    {
        ...
        public static TResult RunSync<TResult>(Func<Task<TResult>> func, bool continueOnCapturedContext = true)
            => _taskFactory
                .StartNew(func)
        ...
        public static void RunSync(Func<Task> func, bool continueOnCapturedContext = true)
            => _taskFactory
                .StartNew(func)
                .Unwrap().ConfigureAwait(continueOnCapturedContext)
                .GetAwaiter()
